...
export const UPDATED_WITHIN_OPTIONS: readonly UpdatedWithin[] = [
  "any",
  "7d",
  "30d",
  "90d",
];
export const ORDER_BY_OPTIONS: readonly OrderBy[] = [
  "updated",
  "priority",
  "created",
];
export const ASSIGNEE_MODE_OPTIONS: readonly AssigneeMode[] = [
  "current",
  "specific",
  "any",
];
export const STATUS_MODE_OPTIONS: readonly StatusMode[] = [
  "unresolved",
  "all",
  "specific",
];
...
export function parseJqlParts(raw: string | undefined): JqlParts {
  ...
  try {
    ...
    return {
      ...
      assigneeMode:
        ASSIGNEE_MODE_OPTIONS.includes(parsed.assigneeMode as AssigneeMode)
      ...
      statuses: Array.isArray(parsed.statuses) && parsed.statuses.every((s) =>
          typeof s === "string"
        )
        ? parsed.statuses
        : [],
      updatedWithin:
        UPDATED_WITHIN_OPTIONS.includes(parsed.updatedWithin as UpdatedWithin)
